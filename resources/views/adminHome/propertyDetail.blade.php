                ...
                <div class="col-12 col-lg-8">
                    <div class="listings-content">
                        ...
                        @if($property->status =='allowed')
                          <h2> <a href="{{route('adminHome.toFeatured', $property->property_id)}}"> <button type="button" class="btn btn-outline-warning" name="button">Featured</button> <a> </h2>
                        @else
                          <h2> <a href="{{route('adminHome.toAllowed', $property->property_id)}}"><button type="button" class="btn btn-outline-success" name="button">Allowed</button> </a> </h2>
                        @endif
                    </div>
                </div>
